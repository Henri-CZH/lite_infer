...
def test1():
    ...
    print("Triton Time cost {:.3f} s".format(t2 - t1))
    print("Torch Time cost {:.3f} s".format(t3 - t2))
...
# B, Seq_Len, H, D = 32, 1024, 12, 128
# Triton Time cost  0.837s
# Torch Time cost  1.268s
# max  tensor(0., device='cuda:0', dtype=torch.float16)
# mean  tensor(0., device='cuda:0', dtype=torch.float16)